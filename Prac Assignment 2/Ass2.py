...
#PART 1
pti=[b'abcdefgh',b'abcdefgi',b'abcdefgj',b'abcdefgk',b'abcdefgl',b'abcdefgm']
get_plot(get_lis(k,pti,b"abcdefgh"),"5 different plaintexts having hamming distance of 1 with respect to base plaintext",0,1)

#PART 2
ptii=[b'abcdefgz',b'abcdefzz',b'abcdezzz',b'abcdzzzz',b'abczzzzz',b'abzzzzzz']
get_plot(get_lis(k,ptii,b"abcdefgh"), \
         "5 different plaintexts having different hamming distance with respect to plaintext",1,1)

#PART 3
k_list=[des(b'stuvwxya'),des(b'stuvwxyb'),des(b'stuvwxyc'),des(b'stuvwxyd'),des(b'stuvwxye'),des(b'stuvwxyf')]
k_list1=[b'stuvwxya',b'stuvwxyb',b'stuvwxyc',b'stuvwxyd',b'stuvwxye',b'stuvwxyf']
...
get_plot(lis,"5 different keys having hamming distance of 1 with respect to base key",0,0)
